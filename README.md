...
| Keyword | Description |
|--------:|:------------|
| `cpu`   | Every instruction executed: all registers + flags + disassembly.  Expect huge ouput for any non‑trivial program.  Useful for tracing crashes or unexpected branches. |
